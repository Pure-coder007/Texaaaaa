<x-filament-panels::page>
    ...
    <div class="bg-white rounded-xl shadow-sm dark:bg-gray-800 mb-4" x-data="{ expanded: false }">
        <div class="p-4">
            <h2 class="text-lg font-semibold mb-3">Select Your Plots</h2>
        ...
        <div class="bg-white rounded-xl shadow-sm dark:bg-gray-800 mb-20" x-data="{ open: false }">
            <div class="p-4">
                ...
                >
                    ...
                    <x-heroicon-o-chevron-down class="w-5 h-5 transform transition-transform"  />
                </button>
